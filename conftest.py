...
def pytest_addoption(parser):
    ...
    parser.addoption('--height_window', action='store', default='1000')

    parser.addoption('--language', action='store', default='en',
                     help="Choose language: 'ru' or 'en'")
    parser.addoption('--headless', action='store', default='tru',
...
def browser(request):
    ...
    if browser_name == "chrome":
        ...
        # Без головый режим для 'Firefox', через импорт библиотеки 'os'
        if headless == 'true':
